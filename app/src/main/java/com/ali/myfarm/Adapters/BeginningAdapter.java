...
public class BeginningAdapter extends RecyclerView.Adapter<BeginningAdapter.ViewHolder> {
    private final List<Bag> bags;

    public BeginningAdapter(List<Bag> bags) {
        this.bags = bags;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.feedBag.setImageDrawable(ContextCompat.getDrawable(holder.itemView.getContext(), R.drawable.initialize));
