...
public class GrowingAdapter extends RecyclerView.Adapter<GrowingAdapter.ViewHolder> {
    private final List<Bag> bags;

    public GrowingAdapter(List<Bag> bags) {
        this.bags = bags;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.feedBag.setImageDrawable(ContextCompat.getDrawable(holder.itemView.getContext(), R.drawable.growing));
